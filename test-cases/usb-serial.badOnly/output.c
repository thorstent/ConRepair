                                         ...
                                         int __usb_bus_thread_finished = 0;
                                         int __tty_thread_finished = 0;
                                         int __usb_cb_thread_finished = 0;
                                         int __serial_bus_thread_finished = 0;
                                         int __fw_module_thread_finished = 0;
                                         int __port_work_thread_finished = 0;
                                         int __attribute_thread_finished = 0;
...
__CPROVER_atomic_begin();                  write_urb_state = 0;                                                   __CPROVER_atomic_end();
                                           ...
                                           __CPROVER_assume(__usb_bus_thread_finished == 1); __assume_dummy=0;
                                           __CPROVER_assume(__tty_thread_finished == 1); __assume_dummy=0;
                                           __CPROVER_assume(__usb_cb_thread_finished == 1); __assume_dummy=0;
                                           __CPROVER_assume(__serial_bus_thread_finished == 1); __assume_dummy=0;
                                           __CPROVER_assume(__fw_module_thread_finished == 1); __assume_dummy=0;
                                           __CPROVER_assume(__port_work_thread_finished == 1); __assume_dummy=0;
                                           __CPROVER_assume(__attribute_thread_finished == 1); __assume_dummy=0;
                                           assert(0);
                                         }
...
__CPROVER_atomic_begin();                  __CPROVER_assume(!port_dev_registered); __assume_dummy=0;              __CPROVER_atomic_end();
                                           ...
                                           unlock_serial_bus();
                                           __serial_bus_thread_finished = 1;
                                         }
